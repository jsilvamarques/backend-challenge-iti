package br.com.jeffersonmarques.backendchallengeiti.config
...
class SwaggerConfig {
    ...
    fun api(): Docket {
        return Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("br.com.jeffersonmarques.backendchallengeiti.controller"))
                .build()
                .apiInfo(apiInfo())
    }
